...
$(document).ready(function() {
    ...
    $("#main-container").bind("mousewheel", function() {
        return false;
    });
    ...
    function sectionimage(anchorLink, index){
        ...
        if (index == 2){
            $("#left2").vegas({
                slides: [
                { src:  "./img/background-left-hakkimizda.jpg"  },
                ],
                delay: 7000,
                cover:false,
                align:'right',
            ...
            $("#right2").vegas({
                slides: [
                { src: "./img/background-right-hakkimizda.jpg" },
                ],
                delay: 7000,
                cover:false,
                align:'left',
        ...
        if (index == 3){
            $("#left3").vegas({
                slides: [
                  { src: "./img/background-left-projeler.jpg" },//MAIN BACKGROUND
            ...
            $("#right3").vegas({
                slides: [
                { src: "./img/background-right-projeler.jpg" },//MAIN BACKGROUND
